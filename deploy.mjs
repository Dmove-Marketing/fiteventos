...
execSync(`ssh ${user}@${server} "chown -R www-data:www-data ${remote_path} && find ${remote_path} -type d -exec chmod 755 {} + && find ${remote_path} -type f -exec chmod 644 {} +"`, { stdio: "inherit" });
